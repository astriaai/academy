...
```bash
npm install
npm run build:segment -- 02-what-is-ai-photoshoot   # renders out/02-what-is-ai-photoshoot.mp4
```
...
npm run build:segment -- 02-what-is-ai-photoshoot
```
